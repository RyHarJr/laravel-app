    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <form action="{{ route('fakultas.store') }}" method="POST" class="p-6 space-y-6">
            ...
            <div>
                ...
                <input type="text" name="kode_fakultas" id="kode_fakultas" value="{{ old('kode_fakultas') }}" class="p-2 w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm @error('kode_fakultas') border-red-500 @enderror" placeholder="Contoh: FIK" maxlength="5" required>
                @error('kode_fakultas')
            ...
            <div>
                ...
                <input type="text" name="nama_fakultas" id="nama_fakultas" value="{{ old('nama_fakultas') }}" class="p-2 w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm @error('nama_fakultas') border-red-500 @enderror" placeholder="Contoh: Fakultas Ilmu Komputer" required>
                @error('nama_fakultas')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" name="dekan_fakultas" id="dekan_fakultas" value="{{ old('dekan_fakultas') }}" class="p-2 w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm @error('dekan_fakultas') border-red-500 @enderror" placeholder="Nama lengkap dekan beserta gelar" required>
